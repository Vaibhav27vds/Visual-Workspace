...
import { ActionCtx, PublicHttpAction, MutationBuilder, QueryBuilder, ActionBuilder } from "../registration.js";
/**
 ...
 * @public
 */
export declare const httpActionGeneric: (func: (ctx: ActionCtx<GenericDataModel>, request: Request) => Promise<Response>) => PublicHttpAction;
