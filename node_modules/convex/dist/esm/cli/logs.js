...
export const logs = new Command("logs").summary("Watch for logs in this project's Convex deployment").description(
  "Stream function logs from your Convex deployment.\nBy default, this streams from your project's dev deployment."
).option("--prod", "Watch logs in this project's production deployment.").addOption(new Option("--admin-key <adminKey>").hideHelp()).addOption(new Option("--url <url>").hideHelp()).showHelpAfterError().action(async (cmdOptions) => {
