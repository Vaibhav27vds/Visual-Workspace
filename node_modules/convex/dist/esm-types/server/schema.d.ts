 ...
 * @module
 */
import { AnyDataModel, GenericDataModel, GenericDocument, GenericTableIndexes, GenericTableSearchIndexes, GenericTableVectorIndexes, TableNamesInDataModel } from "../server/data_model.js";
import { IdField, IndexTiebreakerField, SystemFields, SystemIndexes } from "../server/system_fields.js";
import { Expand } from "../type_utils.js";
import { ObjectValidator, Validator } from "../values/validator.js";
/**
 ...
 * @public
 */
export declare class TableDefinition<Document extends GenericDocument = GenericDocument, FieldPaths extends string = string, Indexes extends GenericTableIndexes = {}, SearchIndexes extends GenericTableSearchIndexes = {}, VectorIndexes extends GenericTableVectorIndexes = {}> {
    private indexes;
     ...
     */
    vectorIndex<IndexName extends string, VectorField extends FieldPaths, FilterFields extends FieldPaths = never>(name: IndexName, indexConfig: Expand<VectorIndexConfig<VectorField, FilterFields>>): TableDefinition<Document, FieldPaths, Indexes, SearchIndexes, Expand<VectorIndexes & Record<IndexName, {
        vectorField: VectorField;
        dimensions: number;
        filterFields: FilterFields;
    }>>>;
...
declare const systemSchema: SchemaDefinition<{
    _scheduled_functions: TableDefinition<{
    ...
    }, ExtractFieldPaths<ObjectValidator<{
        name: Validator<string, false, never>;
        args: Validator<any[], false, never>;
        scheduledTime: Validator<number, false, never>;
        completedTime: Validator<number | undefined, true, never>;
        state: Validator<{
            kind: "pending";
        } | {
            kind: "inProgress";
    ...
    _storage: TableDefinition<{
        _creationTime: number;
        contentType?: string | undefined;
        sha256: string;
        size: number;
    }, ExtractFieldPaths<ObjectValidator<{
        sha256: Validator<string, false, never>;
        size: Validator<number, false, never>;
        contentType: Validator<string | undefined, true, never>;
    }>>, {}, {}, {}>;
}, true>;
